...
{
    public class Studentgurus1Controller : Controller
    {
        ...
        // GET: Studentgurus1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Studentgurus1/Create
